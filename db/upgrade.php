...
function xmldb_collaborate_upgrade($oldversion) {
    ...
    if ($oldversion < 2020082702) {
        ...
        $table->add_field('timecreated', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, 'submissionformat');
        $table->add_field('timemodified', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, 'timecreated');
        ...
        upgrade_mod_savepoint(true, 2020082702, 'collaborate');
    }

      if ($oldversion < 2020082703) {

        // Define field grade to be added to collaborate_submissions.
        $table = new xmldb_table('collaborate_submissions');
        $field = new xmldb_field('grade', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null, 'timemodified');
        ...
        upgrade_mod_savepoint(true, 2020082703, 'collaborate');
    }
